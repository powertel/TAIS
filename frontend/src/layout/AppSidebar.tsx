...
const AppSidebar: React.FC = () => {
  ...
  return (
    <aside
      className={`fixed mt-16 flex flex-col top-0 left-0 bg-white dark:bg-gray-900 dark:border-gray-800 text-gray-900 h-screen transition-all duration-300 ease-in-out z-50 border-r border-gray-200
